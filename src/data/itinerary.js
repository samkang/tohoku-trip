export const initialTripData = [
  ...
  },
  {
    ...
    items: [
      ...
      { 
        id: "d5-6", type: "food", time: "12:00", title: "🍜 午餐：白龍榨醬麵", 
        subTitle: "盛岡車站內",
        location: "岩手県盛岡市盛岡駅",
        desc: "在盛岡車站內品嚐盛岡三大麵之一的榨醬麵。",
        highlight: true,
        menu: [
          { jp: "じゃじゃ麺", cn: "榨醬麵 (必點)" },
          { jp: "半ライス", cn: "半份白飯 (可加點)" }
        ],
        story: "盛岡三大麵之一（另外兩個是冷麵、碗子蕎麥麵）。榨醬麵源自中國的炸醬麵，經在地化改良後成為盛岡的特色美食。白龍是盛岡車站內知名的榨醬麵店。榨醬麵的特色是將炒過的肉末和蔬菜（如洋蔥、青椒、豆芽等）與甜麵醬一起炒製成醬料，淋在Q彈的麵條上，再搭配黃瓜絲、蔥花等配菜。吃法通常是先將醬料與麵條充分拌勻，讓每一根麵條都裹上濃郁的醬汁，口感豐富且層次分明。"
      },
      { 
        id: "d5-7", type: "spot", time: "12:30", title: "🏢 Malios 眺望臺", 
        subTitle: "20 樓展望台",
        location: "岩手県盛岡市",
      ...
      { 
        id: "d5-8", type: "transport", time: "13:30", title: "🚅 搭乘 JR 前往新花卷站", 
        desc: "東北新幹線", 
        route: { from: "盛岡站", to: "新花卷站", trainNo: "東北新幹線", duration: "約12分" },
        highlight: false
      },
      { 
        id: "d5-9", type: "info", time: "13:45", title: "抵達新花卷站", 
        desc: "可先寄放行李在車站置物櫃。", 
        highlight: false
      },
      { 
        id: "d5-10", type: "spot", time: "14:00", title: "⚾ 參觀大谷翔平展覽室", 
